...
class NominaEditarFrame extends JFrame {
    ...
    private void calcularTotal() {
        ...
        totalField.setText(format.format(empleado.getSueldo() * ((float) (7 - faltas) / 7) - infonavit - descuento - vale));
    }
    ...
    private void finish(){
        ...
        nomina.setTotal(0);
        while(i<maxi){
            empleado = manager.selectEmpleado(pagos.get(i).getEmpleado());
            pago = pagos.get(i);
            nomina.addTotal(pago.getSubtotal());
            s += nomina.toString() + "\n";
            s += "Empleado      : (" + pago.getEmpleado() + ") - " + empleado.getNombre() + "\n";
        ...
        new PrintNomina(s);
        manager.updateNomina(nomina);
        manager.updatePagos(nomina.getSemana(),pagos);
    ...
    private void load(int index) {
        ...
        pago = pagos.get(index);
        empleado = manager.selectEmpleado(pago.getEmpleado());
    ...
    public NominaEditarFrame(control.Manager manager, Font font, EmpleadoSeleccionarFrame frame, Nomina nomina) {
        this.frame = frame;
        this.manager = manager;
        this.nomina = nomina;
        format=new DecimalFormat("0.00");
        pagos=manager.selectPagos(nomina.getSemana());
        JOptionPane.showMessageDialog(null, nomina.toString() + ", " + pagos.size() + " empleados activos", "Aviso", JOptionPane.INFORMATION_MESSAGE);
        ...
        layout.setHorizontalGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 128, Short.MAX_VALUE).addGroup(layout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(idField).addComponent(nombreField).addGroup(layout.createSequentialGroup().addComponent(pesosSueldoLabel).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(sueldoField)).addComponent(faltasField, GroupLayout.PREFERRED_SIZE, 64, GroupLayout.PREFERRED_SIZE).addGroup(layout.createSequentialGroup().addComponent(pesosInfonavitLabel).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(infonavitField, GroupLayout.PREFERRED_SIZE, 128, GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(layout.createSequentialGroup().addComponent(pesosDescuentoLabel).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(descuentoField, GroupLayout.PREFERRED_SIZE, 128, GroupLayout.PREFERRED_SIZE)).addGroup(layout.createSequentialGroup().addComponent(pesosValeLabel).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(valeField, GroupLayout.PREFERRED_SIZE, 128, GroupLayout.PREFERRED_SIZE)).addGroup(layout.createSequentialGroup().addComponent(pesosGolpesLabel).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(golpesField)).addGroup(layout.createSequentialGroup().addComponent(pesosPrestamosLabel).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(prestamosField)).addGroup(layout.createSequentialGroup().addComponent(pesosTotalLabel).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(totalField)).addComponent(siguienteButton, GroupLayout.PREFERRED_SIZE, 128, GroupLayout.PREFERRED_SIZE)).addContainerGap());
        layout.setVerticalGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(idLabel).addComponent(idField)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(nombreLabel).addComponent(nombreField)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(sueldoLabel).addComponent(pesosSueldoLabel).addComponent(sueldoField)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(faltasLabel).addComponent(faltasField)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(infonavitLabel).addComponent(pesosInfonavitLabel).addComponent(infonavitField)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(pesosSaldoNuevoLabel)
                    .addComponent(saldoNuevoField))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(descuentoLabel).addComponent(pesosDescuentoLabel).addComponent(descuentoField)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(valeLabel).addComponent(pesosValeLabel).addComponent(valeField)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(golpesLabel).addComponent(pesosGolpesLabel).addComponent(golpesField)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(prestamosLabel).addComponent(pesosPrestamosLabel).addComponent(prestamosField)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(totalLabel).addComponent(pesosTotalLabel).addComponent(totalField)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(anteriorButton).addComponent(siguienteButton)).addContainerGap());
