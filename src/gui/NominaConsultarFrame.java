...
class NominaConsultarFrame extends JFrame {
    ...
    private JLabel faltasField;
    private JLabel infonavitField;
    private JLabel saldoField;
    private JLabel descuentoField;
    private JLabel valeField;
    ...
    public NominaConsultarFrame(control.Manager manager, Font font, EmpleadoSeleccionarFrame frame, Nomina nomina) {
        this.frame = frame;
        ...
        layout.setHorizontalGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup().addComponent(pesosDescuentoLabel).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(descuentoField)).addGroup(layout.createSequentialGroup().addComponent(pesosValeLabel).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(valeField)).addGroup(layout.createSequentialGroup().addComponent(pesosGolpesLabel).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(golpesField)).addGroup(layout.createSequentialGroup().addComponent(pesosPrestamosLabel).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(prestamosField)).addGroup(layout.createSequentialGroup().addComponent(pesosTotalLabel).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(totalField)).addComponent(siguienteButton, GroupLayout.PREFERRED_SIZE, 128, GroupLayout.PREFERRED_SIZE)).addContainerGap());
